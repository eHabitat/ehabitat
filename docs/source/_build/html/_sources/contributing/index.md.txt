(contributing_guide)=
# Contributing to eHabitat
## Welcome
Welcome to the {doc}`eHabitat` project!
If you’re reading this guide, that probably means you’d like to get involved
and start contributing to the project.
eHabitat is a  multi-language open-source project that provides tools for exploratory analysis of Bayesian models.
...
make their contributions compliant with the conventions of the eHabitat python library,
and maximize the probability of such contributions being merged as quickly and as efficiently as possible.

All kinds of contributions to eHabitat, either on its codebase, its documentation,
...
and participate in {ref}`eHabitat governance <eHabitat_org:governance>`.

## Before you begin
Before contributing to eHabitat, please make sure to read and observe the [Code of Conduct](https://github.com/eHabitat-devs/eHabitat/blob/main/CODE_OF_CONDUCT.md).

## Communication
Contact us on [Gitter](https://gitter.im/eHabitat-devs/community)
...
sending pull requests on the main [eHabitat Github repository](https://github.com/eHabitat-devs/eHabitat),
...
to eHabitat. If you prefer video instead of written form, jump to the next section:
{ref}`contributing_webinar` for a recording of an eHabitat core contributor
on both technical and social aspects of contributing to the library.

You can contribute to eHabitat in the following ways:

### Create an issue
[Submit issues](https://github.com/eHabitat-devs/eHabitat/issues/new/choose) for existing bugs or desired enhancements. Check  {ref}`issue_reports` for details on how to write an issue.

### Translate eHabitat website
...
### Write documentation
You can contribute to eHabitat’s documentation by either creating new content or editing existing content.
For instance, you can add new eHabitat examples.
...
Support eHabitat {ref}`outreach initiatives <oureach_contrib>` such as writing blog posts, case studies, getting people to use eHabitat at your company or university, etc.
...
## Contributing to eHabitat webinar
